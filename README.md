...
## 🚀 ¿Cómo usar este material en Google Colab?
...
### Método 1: Abrir directamente desde Google Colab
...
2. En la ventana emergente de bienvenida, seleccione la pestaña **GitHub**.
3. Pegue el enlace de este repositorio (o busque su nombre).
...
### Método 3: Modo Manual (Descargar y Subir)
...
## ⚠️ Solución de Problemas Comunes en GitHub
...
*   **Método 3:** Descargue el archivo (botón *Download raw file*), vaya a Colab y súbalo manualmente.
